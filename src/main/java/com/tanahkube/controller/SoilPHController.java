...
import com.tanahkube.service.SoilPHService;

import jakarta.validation.Valid;

@RestController
@CrossOrigin("*")
@RequestMapping("/api/v1/soilph/")
public class SoilPHController {
    private SoilPHService soilPHService;
    
    public SoilPHController(SoilPHService soilPHService){
    ...
    public WebResponse readData(
        ...
        return this.soilPHService.getAllData(deviceId, search, order, pageSize, pageNumber);
    }
