...
import com.tanahkube.service.SoilMoistureService;

import jakarta.validation.Valid;

@RestController
@CrossOrigin("*")
@RequestMapping("/api/v1/soilmoisture/")
public class SoilMoistureController {
    ...
    public WebResponse readData(
        ...
        return this.soilMoistureService.getAllData(deviceId, search, order, pageSize, pageNumber);
    }
