...
import com.tanahkube.service.RainFallService;
...
public class RainFallController {
    ...
    public WebResponse readData(
        ...
        return this.rainFallService.getAllData(deviceId, search, order, pageSize, pageNumber);
    }
